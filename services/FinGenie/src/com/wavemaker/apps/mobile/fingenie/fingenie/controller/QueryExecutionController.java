...
import com.wavemaker.apps.mobile.fingenie.fingenie.service.FinGenieQueryExecutorService;
...
@RestController(value = "FinGenie.QueryExecutionController")
@Api(value = "QueryExecutionController", description = "Controller class for query execution")
@RequestMapping("/FinGenie/queryExecutor")
