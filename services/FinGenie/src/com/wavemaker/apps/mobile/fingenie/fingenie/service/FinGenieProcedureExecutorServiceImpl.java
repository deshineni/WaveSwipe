...
@Service
public class FinGenieProcedureExecutorServiceImpl implements FinGenieProcedureExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(FinGenieProcedureExecutorServiceImpl.class);

	@Autowired
	@Qualifier("FinGenieWMProcedureExecutor")
