...
public interface UsersService {
    ...
    /*
     * Returns the associated sessions for given Users id.
     *
     * @param userId value of userId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Session instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<Session> findAssociatedSessions(Integer userId, Pageable pageable);

    /*
     * Returns the associated offerFeedbacks for given Users id.
     *
     * @param userId value of userId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<OfferFeedback> findAssociatedOfferFeedbacks(Integer userId, Pageable pageable);
