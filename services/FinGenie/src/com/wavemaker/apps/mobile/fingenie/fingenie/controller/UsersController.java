...
import com.wavemaker.apps.mobile.fingenie.fingenie.service.UsersService;
 ...
 * @see Users
 */
@RestController("FinGenie.UsersController")
@Api(value = "UsersController", description = "Exposes APIs to work with Users resource.")
@RequestMapping("/FinGenie/Users")
public class UsersController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UsersController.class);

    @Autowired
	@Qualifier("FinGenie.UsersService")
    ...
    @ApiOperation(value = "Gets the sessions instance associated with the given id.")
    public Page<Session> findAssociatedSessions(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated sessions");
        return usersService.findAssociatedSessions(id, pageable);
    }
    ...
    public Page<OfferFeedback> findAssociatedOfferFeedbacks(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return usersService.findAssociatedOfferFeedbacks(id, pageable);
    }
